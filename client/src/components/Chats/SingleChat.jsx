          ...
          >
            ...
            />
                ...
                (
                    ...
                    <Profile user={getSenderFull(user,selectedChat.users)}><ViewIcon position={"absolute"} top={1} right={2}/></Profile>
                    </Box>
                
                ):(
                    <>
                    {selectedChat.chatName.toUpperCase()}
                    {<UpdateGroupChat fetchAgain={fetchAgain} setFetchAgain={setFetchAgain} fetchMessages={fetchMessages}><ViewIcon position={"absolute"} top={1} right={2}/></UpdateGroupChat>}
                    </>
                )}
